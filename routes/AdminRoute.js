...
router.post("/", auth, AdminController.criarItem);
router.put("/:id_admin", auth, AdminController.atualizarItem);
router.delete("/:id_admin", auth, AdminController.excluirItem);
